...
### Fixed
- README install docs: use PyPI package `pydump-dd` instead of local `../pydump` path
...
### Changed
- Document Ruff `builtins = ["dd", "dump"]` and IDE import caveats for Laravel-style helpers
...
### Notes
- Version bump: 0.2.0 → 0.2.1 (retag current main; prior `v0.2.0` pointed at older commit)

## [0.2.0] - 2026-07-23

### Notes
- Tag/release `v0.2.0` on GitHub; superseded by `v0.2.1` for full feature set on main
